...
if($fb4['fboard_on']){
	include INFUSIONS."fusionboard4/forum/index.php";
...
if (dbrows($result) != 0) {
	while ($data = dbarray($result)) {
		if ($data['forum_cat_name'] != $current_cat) {
			...
			echo "<tr>\n<td colspan='5' class='forum-caption'><!--forum_cat_name_cell-->".$data['forum_cat_name']."</td>\n</tr>\n";
		}
		$moderators = "";
		...
		echo "<td class='tbl1'><a href='viewforum.php?forum_id=".$data['forum_id']."'><!--forum_name_cell-->".$data['forum_name']."</a><br />\n";
