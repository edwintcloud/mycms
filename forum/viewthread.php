...
if($fb4['fboard_on']){
	include INFUSIONS."fusionboard4/forum/viewthread.php";
...
if ($rows != 0) {
	...
	while ($data = dbarray($result)) {
		...
		if ($current_row == 1) {
			...
			echo "<div style='float:left'><strong><!--forum_thread_title-->".$fdata['thread_subject']."</strong></div>\n</td>\n</tr>\n";
		}
		if ($current_row > 1) { echo "<tr>\n<td colspan='2' class='tbl1' style='height:10px'></td>\n</tr>\n"; }
		echo "<tr>\n<td class='tbl2' style='width:140px'><a href='../profile.php?lookup=".$data['user_id']."'><!--forum_thread_user_name-->".$data['user_name']."</a></td>\n";
		echo "<td class='tbl2'>\n";
