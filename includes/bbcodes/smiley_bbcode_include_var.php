...
"onmouseover"		=>	"",
"onmouseout"		=>	"",
"html_start"		=>	"<div id='bbcode_smileys_list_".$textarea_name."' class='tbl1' style='display:none;border:1px solid black;z-index:1;position:absolute;overflow:auto;width:400px;height:auto;' onclick=\"overlayclose('bbcode_smileys_list_".$textarea_name."');\">",
"includejscript"	=>	"",
"calljscript"		=>	"",
